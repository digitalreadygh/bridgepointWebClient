<template>
  <footer class="text-white body-font bg-green-950">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <span class="ml-3 text-xl text-green-400">Bridgepoint</span>
      </a>
      <p class="mt-2 text-sm text-gray-300">BridgePoint  is a consulting firm established with the mandate to carry out the business of Ag-Tech Consulting, Agribusiness Mapping, Export Aggregator, and Business Support Services to clients both in Ghana and abroad</p>
    </div>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">Copyright © {{ new Date().getFullYear() }} Bridgepoint AgriConsult.
